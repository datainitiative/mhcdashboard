function dashboard2(id, fData){
    ...
    function histoGram(fD){
        ...
        // Create bars for histogram to contain rectangles and perform labels.
        ...
        //Create the perform labels above the rectangles.
        ...
        function mouseover(d){  // utility function to be called on mouseover.
            ...
            var st = fData.filter(function(s){ return s.Org == d[0];})[0],
                nD = d3.keys(st.perform).map(function(s){ return {type:s, perform:st.perform[s]};});
        ...
        hG.update = function(nD, color){
            // update the domain of the y-axis map to reflect change in performs.
            ...
            // transition the perform labels location and change value.
    ...
    function pieChart(pD){
        ...
        function mouseover(d){
            ...
            hG.update(fData.map(function(v){ 
                return [v.Org,v.perform[d.data.type]];}),segColor(d.data.type));
        }
    ...
    function legend(lD){
        ...
        function mouseover(d){
            // call the update function of histogram with new data.
            hG.update(fData.map(function(v){ 
                return [v.Org,v.perform[d.type]];}),segColor(d.type));
        }
    ...
    // calculate total perform by Org for all segment.
